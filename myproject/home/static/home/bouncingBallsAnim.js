...
function exampleScenario() {
	...
	randomBalls(offset, canvas.width-offset, canvas.height-offset-30, canvas.height-offset, 0, 0,28, 1,4, {"radius":4},balls);
	balls.push(new Ball(canvas.width/2, canvas.height-offset-50, 4, 0, -3, {"radius":24, "colour":"#AA00FF"}));
}
